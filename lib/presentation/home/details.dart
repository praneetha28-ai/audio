...
class _DetailsState extends State<Details> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      canPop: true,
      child: BlocListener<ProdBloc, ProdState>(
                ...
                leading: IconButton(onPressed: () {
                  ...
                  Navigator.of(context).pop();
                    ...
                    title: Row(
                      ...
                      children: [
                        badges.Badge(
                          badgeStyle: badges.BadgeStyle(badgeColor: Color(0xff0ACF83)),
                  ...
                  body: SingleChildScrollView(
                      ...
                      """, softWrap: true,
                            ...
                            Image.asset(state.product.prodImage!, height: 300,
                              width: 300,),
                            Container(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () async {
                                  await pushNotificationsAllUsers(
                                      title: state.product.prodName!,
                                      body: "Added to cart");
                                  BlocProvider.of<ProdBloc>(context).add(
